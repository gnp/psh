...
=item * Executable completion now even after initial '!' for shell escape

=item * Some minimal status code testing

=item * Understands environment variable IGNOREEOF
