...
=item * Fixed problem with pod2man and CHANGES.pod reported on Sourceforge - warp [2000-03-09]

=item * SIGTERM is now not ignored anymore and exits the Perl Shell instead  - warp [2000-03-09]
