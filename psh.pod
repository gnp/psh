...
B<FIGNORE> - A colon (":") separated list of file endings to ignore when
...
completion code, Win32 port, i18n code, bash compatibility builtins and
environment variables and some more minor updates.
...
code, various bits of documentation, and other minor updates.
