...
New B<-F> command line switch to disable processing of any pshrc files. - warp [2001-05-21]

=item *

New builtin command B<modules> to display a list of loaded Perl modules. - warp [2001-05-21]
...
name from B<bash> - inspired by a command on the SourceForge
