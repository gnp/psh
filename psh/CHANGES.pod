...
=head1 0.006 [2000-01-02]

Important new features: "Manifest filter" make simple filter writing
easier. The Win32 port has been fixed and enhanced. Recursive globbing
similar to zsh. A new delenv builtin. The kill builtin accepts multiple
PIDs.
