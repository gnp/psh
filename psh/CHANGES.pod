...
=head2 01 Jan 2000 - warp

Features:

=over 4

=item * New builtin 'delenv'

=item * Builtin 'kill' accepts multiple PIDs

=back

=head2 29 Dec 1999 - Omer
...
=item * Makes use of system registry

=item * execute_complex_command()
...
=item * get_known_hosts()

=back


=head2 29 Dec 1999 - warp
...
=item * Moved prompt code and perl evaluation code into own packages

=item * Implementing redirects and pipes in psh

=item * Clean-ups for all code using filenames (now using File::Spec)

=item * More I18N

=item * Removed usage of ENV{HOME} in portable code
