...
classes etc. are in the manpage B<pshdevel>
...
list may be autoloaded. This is initialized on startup by &Psh::Builtins::built_autoload_list() - please see the manpage B<pshdevel> for more information.
...
some bash compatibility builtins and environment variables and some more
minor updates.
