...
Enables Perl's warning mode.

=item * B<-d>

Enables B<psh>'s debugging mode.
...
If the B<-r> flag is present, initialization commands are not read from
the user's F<.pshrc> file but from the specified file.
